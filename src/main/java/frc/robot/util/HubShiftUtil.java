...
public class HubShiftUtil {
  ...
  private static final double minTimeOfFlight = Constants.FiringManager.minTimeOfFlight;
  private static final double maxTimeOfFlight = Constants.FiringManager.maxTimeOfFlight;
