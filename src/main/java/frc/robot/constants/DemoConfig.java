...
public class DemoConfig {
    ...
    public static final boolean maxDriveSpeedOverride = true && demoEnabled; // Set to true to override the normal speed (4.775 m/s)
    ...
    // Layout guide at https://miro.com/app/board/uXjVHsdpnVk=/?share_link_id=345613555076 (requires Clockwork login)
    ...
    public static double demoFieldWidth = Units.feetToMeters(10); // Shorter side, should be side with an AprilTag

    public static double aprilTagHorizontalOffset = Units.inchesToMeters(24); // Offset from the long side of the field
        ...
        public static final AprilTagFieldLayout aprilTagFieldLayout = new AprilTagFieldLayout(
            List.of(
                ...
                new AprilTag(
                    aprilTagBID,
                    new Pose3d(
                        new Translation3d(fieldWidth - aprilTagHorizontalOffset, fieldLength, aprilTagVerticalOffset),
                        new Rotation3d(Units.degreesToRadians(90), 0, 0)
                    )
                )
            ),
