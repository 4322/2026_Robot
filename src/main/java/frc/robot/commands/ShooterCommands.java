...
public class ShooterCommands {
  ...
  public static Command idleOnce(Shooter shooter) {
    return Commands.runOnce(
        () -> {
          shooter.requestIdle();
          Logger.recordOutput("Shooter/command", "idleOnce");
        },
        shooter);
  }
  ...
  public static Command setAutoShoot(Shooter shooter, boolean bool) {
