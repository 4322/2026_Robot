  ...
  private List<RegressionTest> regressionTestCases() {
    return switch (regressTest) {
      ...
      case ALL_AUTOS -> List.of(
          ...
          new RegressionTest(
              "Red/L/LDisruptSweepShoot", AutoName.L_DISRUPT_SWEEP_SHOOT, Alliance.Red),
          new RegressionTest("Red/L/LFullSweepShoot", AutoName.L_FULL_SWEEP_SHOOT, Alliance.Red),
          new RegressionTest("Red/L/LHalfSweepShoot", AutoName.L_HALF_SWEEP_SHOOT, Alliance.Red),
          new RegressionTest(
              "Red/L/LMidlineSweepShoot", AutoName.L_MIDLINE_SWEEP_SHOOT, Alliance.Red),
          new RegressionTest(
              "Red/L/LHalfSuperSweepShoot", AutoName.L_HALF_SUPER_SWEEP_SHOOT, Alliance.Red),
          new RegressionTest(
          ...
          new RegressionTest(
              "Blue/L/LDisruptSweepShoot", AutoName.L_DISRUPT_SWEEP_SHOOT, Alliance.Blue),
          new RegressionTest("Blue/L/LFullSweepShoot", AutoName.L_FULL_SWEEP_SHOOT, Alliance.Blue),
          new RegressionTest("Blue/L/LHalfSweepShoot", AutoName.L_HALF_SWEEP_SHOOT, Alliance.Blue),
          new RegressionTest(
              "Blue/L/LMidlineSweepShoot", AutoName.L_MIDLINE_SWEEP_SHOOT, Alliance.Blue),
          new RegressionTest(
              "Blue/L/LHalfSuperSweepShoot", AutoName.L_HALF_SUPER_SWEEP_SHOOT, Alliance.Blue),
          new RegressionTest(
