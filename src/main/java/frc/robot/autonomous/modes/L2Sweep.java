  ...
  public L2Sweep(Drive drive, LED led, Intake intake, Shooter shooter) {
    ...
    addCommands(
        ...
        new ParallelDeadlineGroup(
            ...
            ShooterCommands.autoUnjam(
                shooter, Constants.Autonomous.firstUnjamDelay, Constants.Autonomous.unjamTimeSec)),
        new ParallelDeadlineGroup(
        ...
        new ParallelDeadlineGroup(
            ...
            ShooterCommands.autoUnjam(
                shooter, Constants.Autonomous.secondUnjamDelay, Constants.Autonomous.unjamTimeSec)),
