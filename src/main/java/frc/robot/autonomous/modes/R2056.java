...
public class R2056 extends SequentialCommandGroup {
  ...
  public R2056(Drive drive, Intake intake, Shooter shooter, LoggedTunableNumber autoStartDelay) {
    firstPath = Robot.R_2056_A;
    ...
    addCommands(
        ...
        new ParallelDeadlineGroup(
            ...
            ShooterCommands.idle(shooter, intake, 15.0, 40.0, 195.0),
